              ...
              <div className="text-left md:col-span-4">
                <div className="flex items-center space-x-3 mb-4">
                  ...
                  <div className="flex flex-col">
                    ...
                    <p className="text-orange-200 text-xs md:text-sm italic">"Sacred Journeys, Divine Experiences"</p>
                  </div>
                </div>

                <div className="text-left">
                  <p className="text-gray-300 mb-3 text-sm leading-relaxed">
                   A divine journey that connects sacred places and spiritual paths, guiding devotees toward peace and blessings.
                  </p>
                  <p className="text-gray-300 mb-3 text-sm leading-relaxed">
                    We celebrate the holy movement of pilgrims across revered temples, ensuring that every step reflects devotion, purity, and the eternal bond between the seeker and the divine.
                  </p>
                </div>
              </div>
