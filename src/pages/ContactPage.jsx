...
// 🔗 Dummy URL – later replace with your real Devocation backend endpoint
const DEVOCATION_API_URL = "https://jsonplaceholder.typicode.com/posts";
...
const validationSchema = Yup.object({
  ...
  message: Yup.string()
    .trim()
    .min(10, "Please provide a helpful message (min 10 characters)")
                  ...
                  <div className="flex-1">
                    ...
                    <Formik
                      ...
                      onSubmit={async (values, { setSubmitting, resetForm }) => {
                        ...
                        console.log("📩 Devocation contact payload:", payload);
                        ...
                        try {
                          ...
                          console.error(
                            "❌ Error submitting devocation form:",
                            err
                          );
                          setApiError(
                            "Unable to submit the form right now. Please check your connection or try again later."
                          );
